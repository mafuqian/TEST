---------------------------------------------
-- Export file for user MBT_USER           --
-- Created by young on 2020/7/20, 14:15:12 --
---------------------------------------------
  ...
  BEGIN
    ...
    BEGIN
      ...
      IF V_RPT_DATA_NO = '2019MBT120A001' THEN
        ...
        declare
          cursor table_cur is
            select * from mbt_120 a where 1=1 and a.RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
            (select 1 from (
 ...
 */
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT130A002' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_130 a where 1=1 and a.RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT140A003' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_140 a where 1=1 and a.RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT210A004' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_210 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF V_RPT_DATA_NO = '2019MBT212A008' THEN
      ...
      declare
        cursor table_cur is
          select * from MBT_210_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND A.PART_TYPE LIKE '%F%' and not exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
                             select B_CONTRACT_CODE from mbt_220 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT215A009' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_215 a where 1=1 and a.RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT220A010' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_220 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
    ...
    ELSIF V_RPT_DATA_NO = '2019MBT220A011' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_220 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT222A012' THEN
      ...
      declare
        cursor table_cur is
          select * from MBT_220_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
                             select B_CONTRACT_CODE from mbt_420 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
 ...
 BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT230A013' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_230 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT340A017' THEN
        ...
        declare
          cursor table_cur is
            select * from mbt_340 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
            (select 1 from (
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT350A018' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_350 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                             select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT410A019' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_410 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                             select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF V_RPT_DATA_NO = '2019MBT412A023' THEN
      ...
      declare
        cursor table_cur is
          select * from MBT_410_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND A.PART_TYPE LIKE '%F%' and not exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
                             select B_CONTRACT_CODE from mbt_420 where B_RPT_DATE = V_RPT_DATE
                             union all
    ...
    ELSIF V_RPT_DATA_NO = '2019MBT412A024' THEN
      ...
      declare
        cursor table_cur is
          select * from MBT_410_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND A.PART_TYPE LIKE '%F%'  and exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
                             select B_CONTRACT_CODE from mbt_220 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT420A025' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_420 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                             select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                             union all
    ...
    ELSIF V_RPT_DATA_NO = '2019MBT420A026' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_420 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
                             select B_CONTRACT_CODE from mbt_220 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT422A027' THEN
      ...
      declare
        cursor table_cur is
          select * from MBT_420_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND A.PART_TYPE LIKE '%B%'  and exists
          (select 1 from (
                           SELECT DISTINCT B_CONTRACT_CODE FROM (
                             select B_CONTRACT_CODE from mbt_220 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT440A028' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_440 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                             select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                             union all
    ...
    BEGIN
      ...
      COMMIT;
        ...
        ELSIF V_RPT_DATA_NO = '2019MBT442A032' THEN
          ...
          declare
            cursor table_cur is
              select * from MBT_440_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND A.PART_TYPE LIKE '%F%' and not exists
              (select 1 from (
                               SELECT DISTINCT B_CONTRACT_CODE FROM (
                                 select B_CONTRACT_CODE from mbt_420 where B_RPT_DATE = V_RPT_DATE
                                 union all
      ...
      COMMIT;
        ELSIF V_RPT_DATA_NO = '2019MBT442A033' THEN
          ...
          declare
            cursor table_cur is
              select * from MBT_440_EX a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND A.PART_TYPE LIKE '%F%'  and exists
              (select 1 from (
                               SELECT DISTINCT B_CONTRACT_CODE FROM (
                                 select B_CONTRACT_CODE from mbt_220 where B_RPT_DATE = V_RPT_DATE
                                 union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT510A034' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_510 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND B_INFO_ID_TYPE = '2' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT510A016' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_510 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' AND B_INFO_ID_TYPE = '1' and not exists
          (select 1 from (
                           SELECT DISTINCT B_NAME,B_ID_TYPE,B_ID_NUM FROM (
                             select B_NAME,B_ID_TYPE,B_ID_NUM  from mbt_110 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  BEGIN
    ...
    IF V_RPT_DATA_NO = '2019MBT610A035' THEN
      ...
      declare
        cursor table_cur is
          select * from mbt_610 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
          (select 1 from (
                           SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                             select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                             union all
...
BEGIN
  ...
  IF V_RPT_DATA_NO = '2019MBT620A036' THEN
    ...
    declare
      cursor table_cur is
        select * from mbt_620 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
        (select 1 from (
                         SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                           select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                           union all
...
BEGIN
  ...
  IF V_RPT_DATA_NO = '2019MBT630A037' THEN
    ...
    declare
      cursor table_cur is
        select * from mbt_630 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
        (select 1 from (
                         SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                           select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                           union all
...
BEGIN
  ...
  IF V_RPT_DATA_NO = '2019MBT640A038' THEN
    ...
    declare
      cursor table_cur is
        select * from mbt_640 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
        (select 1 from (
                         SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                           select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                           union all
...
BEGIN
  ...
  IF V_RPT_DATA_NO = '2019MBT650A039' THEN
    ...
    declare
      cursor table_cur is
        select * from mbt_650 a where 1=1 and a.B_RPT_DATE=V_RPT_DATE AND A.CHECK_FLAG='Y' and not exists
        (select 1 from (
                         SELECT DISTINCT B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM FROM (
                           select B_ENT_NAME,B_ENT_CERT,B_ENT_CERT_NUM from mbt_310 where B_RPT_DATE = V_RPT_DATE
                           union all
