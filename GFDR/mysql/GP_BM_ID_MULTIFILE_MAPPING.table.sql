CREATE TABLE GP_BM_ID_MULTIFILE_MAPPING(
    ...
    MULTI_GUID VARCHAR(64)    COMMENT 'MULTI文件GUID' ,
    PARENT_GUID VARCHAR(64)    COMMENT '主表所在文件GUID' ,
    PARENT_TABLE_NAME VARCHAR(64)    COMMENT '主表名称' ,
    PARENT_PK_COLUMN VARCHAR(64)    COMMENT '主表主键' ,
    PARENT_LINK_COLUMN_NAME VARCHAR(64)    COMMENT '主表所在关联字段' ,
    CHILD_GUID VARCHAR(64)    COMMENT '附表文件GUID' ,
    CHILD_TABLE_NAME VARCHAR(64)    COMMENT '附表名称' ,
    CHILD_LINK_COLUMN_NAME VARCHAR(64)    COMMENT '附表关联字段' ,
    CHILD_FK_COLUMN VARCHAR(64)    COMMENT '附表外键' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '导入文件关系配置' ENGINE=InnoDB;
