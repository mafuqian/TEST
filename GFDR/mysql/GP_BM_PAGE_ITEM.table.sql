CREATE TABLE GP_BM_PAGE_ITEM(
    ...
    NAME VARCHAR(256)    COMMENT '组合对象名称' ,
    DESC_INFO VARCHAR(512)    COMMENT '描述信息' ,
    TYPEID CHAR(32)    COMMENT '类型ID' ,
    VIEWTYPE CHAR(1)    COMMENT '组装类型 0,tab;1,accordion;2,tree' ,
    DEFAULTNO CHAR(32)    COMMENT '默认进入' ,
    OP_ITEM_ID CHAR(32)    COMMENT '关联功能组Id' ,
    STATUS CHAR(1)    COMMENT '状态' ,
    LAST_UPD_TLR VARCHAR(20)    COMMENT '最后更新人' ,
    LAST_UPD_TIME CHAR(17)    COMMENT '最后更新时间' 
) COMMENT = '页面组合表' ENGINE=InnoDB;
