CREATE TABLE GFDR_ITF_TYKHXX(
    ...
    KHDM VARCHAR(60)    COMMENT '' ,
    KHJRJGBM VARCHAR(60)    COMMENT '' ,
    KHNBBM VARCHAR(60)    COMMENT '' ,
    JBCKZH VARCHAR(60)    COMMENT '' ,
    JBZHKHXMC VARCHAR(200)    COMMENT '' ,
    ZCDZ VARCHAR(400)    COMMENT '' ,
    DQDM VARCHAR(6)    COMMENT '' ,
    KHLB VARCHAR(6)    COMMENT '' ,
