CREATE TABLE GP_BM_BMS_BATCH(
    ...
    BATCH_NAME VARCHAR(60)    COMMENT '批量作业名称' ,
    RUN_PLAN VARCHAR(18)    COMMENT '执行计划ID' ,
    STATUS CHAR(1)    COMMENT '运行状态' ,
    CFG_STATUS CHAR(1)    COMMENT '' ,
    NEXT_TIME CHAR(14)    COMMENT '最近执行时间' ,
    LAST_TIME CHAR(14)    COMMENT '' ,
