CREATE TABLE GFDR_BM_EX_RATE(
    ...
    CODE CHAR(3)    COMMENT '货币编码' ,
    NAME VARCHAR(64)    COMMENT '货币名称' ,
    UNIT VARCHAR(64)    COMMENT '货币单位' ,
    TO_USD NUMERIC(10,6)    COMMENT '对美元折算率' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '各种货币对美元折算率表' ENGINE=InnoDB;

ALTER TABLE GFDR_BM_EX_RATE ADD UNIQUE GFDR_BM_EX_RATE_UINDEX(DATA_RPT_DATE,CODE,NAME);