CREATE TABLE GFDR_ITF_DBHTXX(
    ...
    DBHTBM VARCHAR(100)    COMMENT '' ,
    BDBHTBM VARCHAR(100)    COMMENT '' ,
    DBHTLX VARCHAR(2)    COMMENT '' ,
    JYLX VARCHAR(60)    COMMENT '' ,
    DBHTQSRQ_DATE VARCHAR(10)    COMMENT '' ,
    DBHTDQRQ_DATE VARCHAR(10)    COMMENT '' ,
    BZ VARCHAR(3)    COMMENT '' ,
    DBHTJE_AMT NUMERIC(22,2)    COMMENT '' ,
    DBHTJEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    DZYL NUMERIC(12,2)    COMMENT '' ,
    DBRZJLX VARCHAR(3)    COMMENT '' ,
    DBRZJDM VARCHAR(60)    COMMENT '' ,
    DBRGMJJBM VARCHAR(3)    COMMENT '' ,
    DBRHY VARCHAR(3)    COMMENT '' ,
    DBRDQDM VARCHAR(6)    COMMENT '' ,
    DBRQYGM VARCHAR(4)    COMMENT '' ,
