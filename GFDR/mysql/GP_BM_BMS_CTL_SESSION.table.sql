CREATE TABLE GP_BM_BMS_CTL_SESSION(
    ...
    RUN_ORDER INT    COMMENT '0-未运行  1-运行中   2-运行完成' ,
    PRIMARY KEY (DATA_ID)
) COMMENT = '批量作业状态表' ENGINE=InnoDB;

ALTER TABLE GP_BM_BMS_CTL_SESSION ADD INDEX IDX_GP_BM_BMS_CTL_SESSION_01(SESSION_ID);