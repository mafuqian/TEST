CREATE TABLE GFDR_PM_CLZQFX(
    ...
    QMZQMZ_AMT NUMERIC(22,2)    COMMENT '期末债券面值' ,
    QMZQMZZRMB_AMT NUMERIC(22,2)    COMMENT '期末债券面值折人民币' ,
    QMZQYE_AMT NUMERIC(22,2)    COMMENT '期末债券余额' ,
    QMZQYEZRMB_AMT NUMERIC(22,2)    COMMENT '期末债券余额折人民币' ,
    ZQZWDJR_DATE VARCHAR(8)    COMMENT '债权债务登记日' ,
    QXR_DATE VARCHAR(8)    COMMENT '起息日' ,
    DFRQ_DATE VARCHAR(8)    COMMENT '兑付日期' ,
    FXFS VARCHAR(2)    COMMENT '付息方式' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '存量债券发行信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_CLZQFX ADD UNIQUE U_CLZQFX(DATA_RPT_DATE,JRJGDM,ZQDM);