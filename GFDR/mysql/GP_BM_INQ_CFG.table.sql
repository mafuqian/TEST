CREATE TABLE GP_BM_INQ_CFG(
    ...
    SQL_ID VARCHAR(64)    COMMENT '' ,
    SQL_STRING VARCHAR(4000)    COMMENT '' ,
    DETAIL_SQL_STRING VARCHAR(4000)    COMMENT '' ,
    SYSTEM VARCHAR(32)    COMMENT '' ,
    PRIMARY KEY (DATA_ID)
) COMMENT = '通用查询配置表' ENGINE=InnoDB;

ALTER TABLE GP_BM_INQ_CFG ADD UNIQUE UNIQUE_INQ_CFG(SQL_ID);