CREATE TABLE GFDR_PM_SPVFSX(
    ...
    TDMDZTLX VARCHAR(2)    COMMENT '特定目的载体类型' ,
    ZGCPTJBM VARCHAR(30)    COMMENT '资管产品统计编码' ,
    TDMDZTDM VARCHAR(30)    COMMENT '特定目的载体代码' ,
    FXRDM VARCHAR(60)    COMMENT '发行人代码' ,
    FXRDQDM VARCHAR(6)    COMMENT '发行人地区代码' ,
    YXFS VARCHAR(2)    COMMENT '运行方式' ,
    RGRQ_DATE VARCHAR(8)    COMMENT '认购日期' ,
    DQRQ_DATE VARCHAR(8)    COMMENT '到期日期' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '特定目的载体投资发生额信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_SPVFSX ADD UNIQUE U_SPVFSX(DATA_RPT_DATE,JRJGDM,ZGCPTJBM,JYRQ_DATE,JYFX);