CREATE TABLE GP_BM_FUNCTION(
    ...
    FUNCNAME VARCHAR(256)    COMMENT '权限名/菜单名' ,
    PAGEPATH VARCHAR(100)    COMMENT '访问路径(相对路径)' ,
    LOCATION NUMERIC(38,0)    COMMENT '1－在左侧树菜单；2－在上面导航条' ,
    ISDIRECTORY NUMERIC(38,0)    COMMENT '目录节点：1是；0否' ,
    LASTDIRECTORY VARCHAR(32)    COMMENT '指定上级FUNCID，0为根节点' ,
    SHOWSEQ NUMERIC(38,0)    COMMENT '' ,
    SYS_NUM VARCHAR(20)    COMMENT '' ,
    FUNC_CLASS CHAR(1)    COMMENT '目前不使用' ,
    FUNC_TYPE CHAR(1)    COMMENT '目前不使用' ,
    WORKFLOW_FLAG CHAR(1)    COMMENT '目前不使用' ,
    UP_FUNC_CODE CHAR(10)    COMMENT '目前不使用' ,
    FUNC_DESC VARCHAR(60)    COMMENT '' ,
    STATUS CHAR(1)    COMMENT '1有效，0无效' ,
    EFFECT_DATE CHAR(8)    COMMENT '' ,
    EXPIRE_DATE CHAR(8)    COMMENT '' ,
    TIMESTAMPS VARCHAR(100)    COMMENT '' ,
    MISCFLGS CHAR(20)    COMMENT '' ,
    MISC VARCHAR(256)    COMMENT '' ,
    ICON_CLS VARCHAR(50)    COMMENT '引用的图标名称' ,
