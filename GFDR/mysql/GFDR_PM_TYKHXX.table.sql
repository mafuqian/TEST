CREATE TABLE GFDR_PM_TYKHXX(
    ...
    KHDM VARCHAR(60)    COMMENT '客户代码' ,
    KHJRJGBM VARCHAR(60)    COMMENT '客户金融机构编码' ,
    KHNBBM VARCHAR(60)    COMMENT '客户内部编码' ,
    JBCKZH VARCHAR(60)    COMMENT '基本存款账号' ,
    JBZHKHXMC VARCHAR(200)    COMMENT '基本账户开户行名称' ,
    ZCDZ VARCHAR(400)    COMMENT '注册地址' ,
    DQDM VARCHAR(6)    COMMENT '地区代码' ,
    KHLB VARCHAR(6)    COMMENT '客户类别' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '同业客户基础信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_TYKHXX ADD UNIQUE U_TYKHXX(DATA_RPT_DATE,JRJGDM,KHDM);