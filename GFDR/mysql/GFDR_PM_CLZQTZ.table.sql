CREATE TABLE GFDR_PM_CLZQTZ(
    ...
    ZQYE_AMT NUMERIC(22,2)    COMMENT '债券余额' ,
    ZQYEZRMB_AMT NUMERIC(22,2)    COMMENT '债券余额折人民币' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '存量债券投资信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_CLZQTZ ADD UNIQUE U_CLZQTZ(DATA_RPT_DATE,JRJGDM,ZQDM);