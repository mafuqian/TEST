CREATE TABLE GP_BM_TABLE_CHECK_CONFIG_DTL(
    ...
    CK_GROUP VARCHAR(32) NOT NULL   COMMENT '' ,
    CHECK_TYPE CHAR(1)    COMMENT '' ,
    CHECK_FLAG CHAR(1)    COMMENT '校验标识' ,
    SEQ_NO NUMERIC(38,0)    COMMENT '' ,
...
ALTER TABLE GP_BM_TABLE_CHECK_CONFIG_DTL ADD UNIQUE SYS_C00245219(DATA_ID);