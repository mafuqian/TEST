CREATE TABLE GFDR_ITF_TYJDFS(
    ...
    JYDSDMLB VARCHAR(3)    COMMENT '' ,
    HTBM VARCHAR(100)    COMMENT '' ,
    JYLSH VARCHAR(60)    COMMENT '' ,
    ZCFZLX VARCHAR(4)    COMMENT '' ,
    CPLB VARCHAR(4)    COMMENT '' ,
    HTQSRQ_DATE VARCHAR(10)    COMMENT '' ,
    HTDQRQ_DATE VARCHAR(10)    COMMENT '' ,
    HTSJZZRQ_DATE VARCHAR(10)    COMMENT '' ,
    ...
    DJJZLX VARCHAR(4)    COMMENT '' ,
    JZLL NUMERIC(15,5)    COMMENT '' ,
    JXFS VARCHAR(3)    COMMENT '' ,
    FSJQBZ VARCHAR(1)    COMMENT '' ,
