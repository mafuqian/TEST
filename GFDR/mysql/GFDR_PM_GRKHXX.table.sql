CREATE TABLE GFDR_PM_GRKHXX(
    ...
    GJ VARCHAR(2)    COMMENT '国籍' ,
    MZ VARCHAR(2)    COMMENT '民族' ,
    XB VARCHAR(2)    COMMENT '性别' ,
    ZGXL VARCHAR(2)    COMMENT '最高学历' ,
    CSRQ_DATE VARCHAR(8)    COMMENT '出生日期' ,
    DQDM VARCHAR(6)    COMMENT '地区代码' ,
    GRNSR_AMT NUMERIC(22,2)    COMMENT '个人年收入' ,
    JTNSR_AMT NUMERIC(22,2)    COMMENT '家庭年收入' ,
    HYQK VARCHAR(3)    COMMENT '婚姻情况' ,
    SFGLF VARCHAR(1)    COMMENT '是否关联方' ,
    SXED_AMT NUMERIC(22,2)    COMMENT '授信额度' ,
    YYED_AMT NUMERIC(22,2)    COMMENT '已用额度' ,
    GRKHSFBZ VARCHAR(10)    COMMENT '个人客户身份标识' ,
    GTGSHYYZZDM VARCHAR(400)    COMMENT '个体工商户营业执照代码' ,
    XWQYTYSHXYDM VARCHAR(400)    COMMENT '小微企业统一社会信用代码' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '个人客户基础信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_GRKHXX ADD UNIQUE U_GRKHXX(DATA_RPT_DATE,JRJGDM,KHZJLX,KHZJDM);