CREATE TABLE GFDR_ITF_JRJGFZ(
    ...
    JRJGMC VARCHAR(200)    COMMENT '' ,
    JRJGDM VARCHAR(18)    COMMENT '' ,
    JRJGBM VARCHAR(14)    COMMENT '' ,
    NBJGH VARCHAR(30)    COMMENT '' ,
    XKZH VARCHAR(30)    COMMENT '' ,
    ZFHH VARCHAR(30)    COMMENT '' ,
    JGJB VARCHAR(2)    COMMENT '' ,
    ZSSJGLJGMC VARCHAR(200)    COMMENT '' ,
    ZSSJGLJGJRJGBM VARCHAR(14)    COMMENT '' ,
    ZSSJGLJGNBJGH VARCHAR(30)    COMMENT '' ,
    ZCDZ VARCHAR(400)    COMMENT '' ,
    DQDM VARCHAR(6)    COMMENT '' ,
    CLSJ_DATE VARCHAR(10)    COMMENT '' ,
    YYZT VARCHAR(2)    COMMENT '' ,
