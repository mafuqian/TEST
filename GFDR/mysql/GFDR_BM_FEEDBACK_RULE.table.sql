CREATE TABLE GFDR_BM_FEEDBACK_RULE(
    ...
    BATCH_ID VARCHAR(20)    COMMENT '反馈文件批次' ,
    REPORT_CODE VARCHAR(60)    COMMENT '报表编码' ,
    COLUMN_NAME VARCHAR(120)    COMMENT '列名' ,
    RULE_ID VARCHAR(60)    COMMENT '规则编号' ,
    RULE_TYPE VARCHAR(30)    COMMENT '规则类型' ,
    ERR_COUNT NUMERIC(20)    COMMENT '错误计数' ,
    RULE_NAME VARCHAR(400)    COMMENT '规则名称' ,
    RULE_DESC VARCHAR(4000)    COMMENT '规则描述' ,
    EXAMPLE_LINE VARCHAR(200)    COMMENT '样例数据行号' ,
    ...
    ERR_REASON VARCHAR(4000)    COMMENT '' ,
    REPORT_NAME VARCHAR(400)    COMMENT '' ,
    PRIMARY KEY (DATA_ID)
