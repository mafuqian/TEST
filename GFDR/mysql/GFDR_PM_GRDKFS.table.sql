CREATE TABLE GFDR_PM_GRDKFS(
    ...
    DKLLCXDJR_DATE VARCHAR(8)    COMMENT '贷款利率重新定价日' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '个人贷款发生额信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_GRDKFS ADD UNIQUE U_GRDKFS(DATA_RPT_DATE,JRJGDM,DKJJBM,DKHTBM,JYLSH);