CREATE TABLE GFDR_PM_TYJDFS(
    ...
    HTSJZZRQ_DATE VARCHAR(8)    COMMENT '合同实际终止日期' ,
    BZ VARCHAR(3)    COMMENT '币种' ,
    FSJE_AMT NUMERIC(22,2)    COMMENT '发生金额' ,
    FSJEZRMB_AMT NUMERIC(22,2)    COMMENT '发生金额折人民币' ,
    ...
    FSJQBZ VARCHAR(1)    COMMENT '发生/结清标识' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '同业借贷发生额信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_TYJDFS ADD UNIQUE U_TYJDFS(DATA_RPT_DATE,JRJGDM,HTBM,JYLSH);