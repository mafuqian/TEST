CREATE TABLE GP_BM_WIDGET_CFG(
    ...
    FUNCID VARCHAR(50)    COMMENT '' ,
    DEPART VARCHAR(30)    COMMENT '' ,
    FIELDNAME VARCHAR(2000)    COMMENT '' ,
    TYPE VARCHAR(1)    COMMENT '显示类型' ,
    ...
    USERNAMELIST VARCHAR(180)    COMMENT '' ,
    FUNCNAMELIST VARCHAR(180)    COMMENT '' ,
    FIELDPARTNAMELIST VARCHAR(180)    COMMENT '' ,
    FIELDPART VARCHAR(180)    COMMENT '' ,
    FIELDNAMEDESC VARCHAR(180)    COMMENT '' ,
    BUTTONTYPE VARCHAR(180)    COMMENT '' ,
    BUTTONPARTNAMELIST VARCHAR(180)    COMMENT '' ,
    BUTTONPART VARCHAR(180)    COMMENT '' ,
    BUTTONNAME VARCHAR(180)    COMMENT '' ,
    BUTTONID VARCHAR(180)    COMMENT '' 
