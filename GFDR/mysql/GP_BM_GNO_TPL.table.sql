CREATE TABLE GP_BM_GNO_TPL(
    ...
    TPL_LANG VARCHAR(8)    COMMENT '模板语言' ,
    CHL_ID VARCHAR(32)    COMMENT '渠道' ,
    MSG_FMT VARCHAR(32)    COMMENT '报文格式' ,
    MSG_TITLE VARCHAR(180)    COMMENT '消息标题' ,
    TPL_DATA VARCHAR(4000)    COMMENT '模板数据' ,
