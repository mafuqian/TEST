CREATE TABLE GFDR_ITF_TYCKFS(
    ...
    YWLX VARCHAR(4)    COMMENT '' ,
    JYDSZJLX VARCHAR(3)    COMMENT '' ,
    JYDSDM VARCHAR(60)    COMMENT '' ,
    CKZHBM VARCHAR(60)    COMMENT '' ,
    CKXYDM VARCHAR(60)    COMMENT '' ,
    XYQSRQ_DATE VARCHAR(10)    COMMENT '' ,
    XYDQRQ_DATE VARCHAR(10)    COMMENT '' ,
    BZ VARCHAR(3)    COMMENT '' ,
    JYJE_AMT NUMERIC(22,2)    COMMENT '' ,
    JYJEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    JYRQ_DATE VARCHAR(10)    COMMENT '' ,
    JYLSH VARCHAR(60)    COMMENT '' ,
    LLSP NUMERIC(15,5)    COMMENT '' ,
    JYZHH VARCHAR(60)    COMMENT '' ,
    JYZHKHHH VARCHAR(30)    COMMENT '' ,
    JYDSZHH VARCHAR(60)    COMMENT '' ,
