CREATE TABLE GP_BM_BRANCH_EXTEND_PENDING(
    ...
    EXTEND_FIELDS1 VARCHAR(180)    COMMENT '扩展字段1' ,
    EXTEND_FIELDS2 VARCHAR(180)    COMMENT '扩展字段2' ,
    EXTEND_FIELDS3 VARCHAR(180)    COMMENT '扩展字段3' ,
    EXTEND_FIELDS4 VARCHAR(180)    COMMENT '扩展字段4' ,
    EXTEND_FIELDS5 VARCHAR(180)    COMMENT '扩展字段5' ,
    EXTEND_FIELDS6 VARCHAR(180)    COMMENT '扩展字段6' ,
