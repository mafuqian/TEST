CREATE TABLE GP_BM_CODE_LIST(
    ...
    CODE_SCHEMA VARCHAR(30)    COMMENT '编码集' ,
    CODE_ITEM VARCHAR(30)    COMMENT '编码项目' ,
    CODE_VALUE VARCHAR(60)    COMMENT '数据编码' ,
    CODE_NAME VARCHAR(180)    COMMENT '数据编码名称' ,
    P_CODE_VALUE VARCHAR(60)    COMMENT '父级数据编码' ,
