CREATE TABLE GP_BM_UPLOAD_CFG(
    ...
    FILE_SERVICE VARCHAR(180)    COMMENT '文件服务' ,
    FILE_EXTS VARCHAR(500)    COMMENT '允许扩展名' ,
    EXCLUDE_EXTS VARCHAR(500)    COMMENT '排除文件扩展名列表' ,
    MAX_SIZE NUMERIC(38,0)    COMMENT '文件最大大小' ,
    FILE_CHARSET VARCHAR(32)    COMMENT '文件编码' ,
    PERMISSION_TYPE VARCHAR(2)    COMMENT '控制方式' ,
    PERMISSION_DATA VARCHAR(180)    COMMENT '控制方式数据' ,
    SAVE_PATH VARCHAR(300)    COMMENT '存放路径' ,
    FILE_NAME_TPL VARCHAR(180)    COMMENT '文件名模板' ,
    JOB_TYPE VARCHAR(1)    COMMENT '类型' ,
    AFTER_BEAN VARCHAR(180)    COMMENT '后续操作' ,
    STATUS VARCHAR(2)    COMMENT '启用状态' ,
