CREATE TABLE GFDR_BM_RPT_ORG(
    ...
    NBJGH VARCHAR(32)    COMMENT '内部结构号' ,
    JRJGDM VARCHAR(32)    COMMENT '金融机构代码' ,
    JGMC VARCHAR(512)    COMMENT '机构名称' ,
    P_NBJGH VARCHAR(200)    COMMENT '上级内部机构号' ,
    FILE_NAME VARCHAR(2000)    COMMENT '文件名生成规则' ,
    IS_REPORT VARCHAR(2)    COMMENT '是否上报' ,
