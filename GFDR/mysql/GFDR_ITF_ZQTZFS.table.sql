CREATE TABLE GFDR_ITF_ZQTZFS(
    ...
    ZQDM VARCHAR(60)    COMMENT '' ,
    ZQZTGJG VARCHAR(3)    COMMENT '' ,
    ZQPZ VARCHAR(6)    COMMENT '' ,
    ZQXYJB VARCHAR(3)    COMMENT '' ,
    BZ VARCHAR(3)    COMMENT '' ,
    ZQZWDJR_DATE VARCHAR(10)    COMMENT '' ,
    QXR_DATE VARCHAR(10)    COMMENT '' ,
    DFRQ_DATE VARCHAR(10)    COMMENT '' ,
    PMLL NUMERIC(15,5)    COMMENT '' ,
    FXRZJDM VARCHAR(60)    COMMENT '' ,
    FXRDQDM VARCHAR(6)    COMMENT '' ,
    FXRHY VARCHAR(1)    COMMENT '' ,
    FXRQYGM VARCHAR(4)    COMMENT '' ,
    FXRJJCF VARCHAR(3)    COMMENT '' ,
    FXRGMJJBM VARCHAR(3)    COMMENT '' ,
    JYRQ_DATE VARCHAR(10)    COMMENT '' ,
    JYLSH VARCHAR(60)    COMMENT '' ,
    CJJE_AMT NUMERIC(22,2)    COMMENT '' ,
    CJJEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    MRMCBZ VARCHAR(1)    COMMENT '' ,
