CREATE TABLE GFDR_BM_IJ_CFG(
    ...
    REPORT_CODE VARCHAR(100)    COMMENT '报表编码' ,
    REPORT_NAME VARCHAR(200)    COMMENT '报表名称' ,
    SHEET_CODE VARCHAR(100)    COMMENT '表单代码' ,
    SHEET_NAME VARCHAR(200)    COMMENT '表单名称' ,
    DATA_ATTRIBUTE VARCHAR(1)    COMMENT '数据属性' ,
    DATA_CURRENCY VARCHAR(7)    COMMENT '币种' ,
    DATA_UNIT VARCHAR(1)    COMMENT '金额单位' ,
    DATA_TYPE VARCHAR(1)    COMMENT '数值类型' ,
