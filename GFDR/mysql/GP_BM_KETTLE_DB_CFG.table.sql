CREATE TABLE GP_BM_KETTLE_DB_CFG(
    ...
    DKH VARCHAR(64)    COMMENT '端口号' ,
    SJKLX VARCHAR(40)    COMMENT '数据库类型' ,
    YHM VARCHAR(40)    COMMENT '用户名' ,
    MM VARCHAR(200)    COMMENT '密码' ,
    SJKLJM VARCHAR(40)    COMMENT '数据库连接名' ,
    SJKM VARCHAR(512)    COMMENT '数据库名' ,
