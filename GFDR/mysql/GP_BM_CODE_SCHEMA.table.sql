CREATE TABLE GP_BM_CODE_SCHEMA(
    ...
    CODE_SCHEMA_NAME VARCHAR(180)    COMMENT '方案名称' ,
    SCHEMA_TYPE VARCHAR(1)    COMMENT '方案类型 1-精细控制模式；2-简化控制模式' ,
    SQL_STRING VARCHAR(4000)    COMMENT '权限串 sql语句' ,
