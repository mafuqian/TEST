CREATE TABLE GFDR_PM_DBWXX(
    ...
    DBWBM VARCHAR(100)    COMMENT '担保物编码' ,
    DBWLB VARCHAR(3)    COMMENT '担保物类别' ,
    QZBH VARCHAR(500)    COMMENT '权证编号' ,
    SFDYSW VARCHAR(1)    COMMENT '是否第一顺位' ,
    PGFS VARCHAR(2)    COMMENT '评估方式' ,
    PGFF VARCHAR(2)    COMMENT '评估方法' ,
    PGJZ_AMT NUMERIC(22,2)    COMMENT '评估价值' ,
    PGJZR_DATE VARCHAR(8)    COMMENT '评估基准日' ,
    DBWPMJZ_AMT NUMERIC(22,2)    COMMENT '担保物票面价值' ,
    YXSCQSE_AMT NUMERIC(22,2)    COMMENT '优先受偿权数额' ,
    GZZQ VARCHAR(2)    COMMENT '估值周期' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '担保物信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_DBWXX ADD UNIQUE U_DBWXX(DATA_RPT_DATE,JRJGDM,NBJGH,DBHTBM,BDBHTBM,DBWBM);