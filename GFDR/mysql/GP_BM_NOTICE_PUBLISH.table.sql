CREATE TABLE GP_BM_NOTICE_PUBLISH(
    ...
    MODULE CHAR(30)    COMMENT '' ,
    MENU CHAR(30)    COMMENT '' ,
    RANK CHAR(1)    COMMENT '' ,
    TYPE CHAR(1)    COMMENT '' ,
    PUBLISH_DATE CHAR(8)    COMMENT '' ,
    EFFECTIVE_DATE CHAR(8)    COMMENT '' ,
    NOTICE_CONTENT VARCHAR(4000)    COMMENT '' ,
    ...
    SCOPE CHAR(1)    COMMENT '' ,
    TITLE VARCHAR(200)    COMMENT '' 
) COMMENT = '公告表' ENGINE=InnoDB;
