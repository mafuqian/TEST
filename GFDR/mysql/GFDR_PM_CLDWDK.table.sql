CREATE TABLE GFDR_PM_CLDWDK(
    ...
    DKZQDQRQ_DATE VARCHAR(8)    COMMENT '贷款展期到期日期' ,
    BZ VARCHAR(3)    COMMENT '币种' ,
    DKYE_AMT NUMERIC(22,2)    COMMENT '贷款余额' ,
    DKYEZRMBYE_AMT NUMERIC(22,2)    COMMENT '贷款余额折人民币余额' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '存量单位贷款信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_CLDWDK ADD UNIQUE U_CLDWDK(DATA_RPT_DATE,JRJGDM,DKJJBM,DKHTBM);