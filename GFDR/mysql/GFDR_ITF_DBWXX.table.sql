CREATE TABLE GFDR_ITF_DBWXX(
    ...
    DBWBM VARCHAR(100)    COMMENT '' ,
    DBWLB VARCHAR(3)    COMMENT '' ,
    QZBH VARCHAR(500)    COMMENT '' ,
    SFDYSW VARCHAR(1)    COMMENT '' ,
    PGFS VARCHAR(2)    COMMENT '' ,
    PGFF VARCHAR(2)    COMMENT '' ,
    PGJZ_AMT NUMERIC(22,2)    COMMENT '' ,
    PGJZR_DATE VARCHAR(10)    COMMENT '' ,
    DBWPMJZ_AMT NUMERIC(22,2)    COMMENT '' ,
    YXSCQSE_AMT NUMERIC(22,2)    COMMENT '' ,
    GZZQ VARCHAR(2)    COMMENT '' ,
