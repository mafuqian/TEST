CREATE TABLE GFDR_ITF_SPVFSX(
    ...
    TDMDZTLX VARCHAR(2)    COMMENT '' ,
    ZGCPTJBM VARCHAR(30)    COMMENT '' ,
    TDMDZTDM VARCHAR(30)    COMMENT '' ,
    FXRDM VARCHAR(60)    COMMENT '' ,
    FXRDQDM VARCHAR(6)    COMMENT '' ,
    YXFS VARCHAR(2)    COMMENT '' ,
    RGRQ_DATE VARCHAR(10)    COMMENT '' ,
    DQRQ_DATE VARCHAR(10)    COMMENT '' ,
