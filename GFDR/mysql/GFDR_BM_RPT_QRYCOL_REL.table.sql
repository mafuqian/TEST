CREATE TABLE GFDR_BM_RPT_QRYCOL_REL(
    ...
    QUERY_COLUMN_NAME VARCHAR(4000)    COMMENT '查询字段名' ,
    QUERY_COLUMN_COMMENT VARCHAR(4000)    COMMENT '查询字段中文名' ,
    QUERY_TYPE VARCHAR(32)    COMMENT '查询方式' ,
    IS_REQUIRED VARCHAR(32)    COMMENT '是否必填' ,
    EDIT_TYPE VARCHAR(32)    COMMENT '编辑类型' ,
    DATA_TYPE VARCHAR(32)    COMMENT '数据类型' ,
    COLUMN_LENGTH VARCHAR(32)    COMMENT '允许最大长度' ,
    READONLY VARCHAR(32)    COMMENT '只读状态' ,
    DATA_DIC VARCHAR(32)    COMMENT '数据字典' ,
    CQ_QUERY VARCHAR(512)    COMMENT 'CQ查询' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = 'GFDR_BM_RPT_QRYCOL_REL' ENGINE=InnoDB;
