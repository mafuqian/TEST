CREATE TABLE GP_BM_FUNCTION_TABLE(
    ...
    TABLENAME VARCHAR(60)    COMMENT '' ,
    FUNCNAME VARCHAR(180)    COMMENT '' 
) COMMENT = '菜单数据库表映射表' ENGINE=InnoDB;

ALTER TABLE GP_BM_FUNCTION_TABLE ADD UNIQUE SYS_C00244964(DATA_ID);