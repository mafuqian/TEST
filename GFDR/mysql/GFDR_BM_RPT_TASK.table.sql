CREATE TABLE GFDR_BM_RPT_TASK(
    ...
    NBJGH VARCHAR(20)    COMMENT '' ,
    FILE_PATH VARCHAR(200)    COMMENT '' ,
    FILE_NAME VARCHAR(200)    COMMENT '' ,
    REPORT_CODE VARCHAR(80)    COMMENT '' ,
    REPORT_NAME VARCHAR(200)    COMMENT '' ,
    REPORT_PERIOD VARCHAR(2)    COMMENT '' ,
    PROCESS_SQL VARCHAR(4000)    COMMENT '' ,
    WRITE_FILE_SQL VARCHAR(4000)    COMMENT '' ,
    VALIDATE_SQL VARCHAR(4000)    COMMENT '' ,
    REPORT_BM_NAME VARCHAR(80)    COMMENT '' ,
    REPORT_FILE_NAME VARCHAR(80)    COMMENT '' ,
    TASK_STATUS VARCHAR(2)    COMMENT '' ,
    CJ_START_DATE VARCHAR(8)    COMMENT '' ,
    CJ_END_DATE VARCHAR(8)    COMMENT '' ,
    ...
    TOTAL_COUNT NUMERIC(10)    COMMENT '' ,
    START_TIME VARCHAR(14)    COMMENT '' ,
    END_TIME VARCHAR(14)    COMMENT '' ,
    DOWNLOAD_TIME VARCHAR(14)    COMMENT '' ,
    PRIMARY KEY (DATA_ID)
