CREATE TABLE GFDR_ITF_GRKHXX(
    ...
    GJ VARCHAR(2)    COMMENT '' ,
    MZ VARCHAR(2)    COMMENT '' ,
    XB VARCHAR(2)    COMMENT '' ,
    ZGXL VARCHAR(2)    COMMENT '' ,
    CSRQ_DATE VARCHAR(10)    COMMENT '' ,
    DQDM VARCHAR(6)    COMMENT '' ,
    GRNSR_AMT NUMERIC(22,2)    COMMENT '' ,
    JTNSR_AMT NUMERIC(22,2)    COMMENT '' ,
    HYQK VARCHAR(3)    COMMENT '' ,
    SFGLF VARCHAR(1)    COMMENT '' ,
    SXED_AMT NUMERIC(22,2)    COMMENT '' ,
    YYED_AMT NUMERIC(22,2)    COMMENT '' ,
    GRKHSFBZ VARCHAR(10)    COMMENT '' ,
    GTGSHYYZZDM VARCHAR(400)    COMMENT '' ,
    XWQYTYSHXYDM VARCHAR(400)    COMMENT '' ,
