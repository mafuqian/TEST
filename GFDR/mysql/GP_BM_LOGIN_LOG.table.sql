CREATE TABLE GP_BM_LOGIN_LOG(
    ...
    TLR_NO VARCHAR(20)    COMMENT '操作员编号' ,
    BR_NO VARCHAR(20)    COMMENT '部门编号' ,
    LOGIN_SUC_TM CHAR(14)    COMMENT '登录时间' ,
    LOGIN_OUT_TM CHAR(14)    COMMENT '退出时间' ,
    LOGIN_FAIL_TM CHAR(14)    COMMENT '登录失败时间' ,
    LOGIN_ADDR VARCHAR(512)    COMMENT 'IP' ,
    LOGIN_REMARK VARCHAR(256)    COMMENT '登录信息' ,
    SESSION_ID VARCHAR(32)    COMMENT '' ,
    CRT_TM CHAR(14)    COMMENT '创建时间' ,
    PRIMARY KEY (DATA_ID)
) COMMENT = '操作员登陆日志表' ENGINE=InnoDB;
