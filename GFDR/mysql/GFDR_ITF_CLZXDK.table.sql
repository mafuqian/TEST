CREATE TABLE GFDR_ITF_CLZXDK(
    ...
    SFGTGSHDK VARCHAR(1)    COMMENT '' ,
    SFXWQYZDK VARCHAR(1)    COMMENT '' ,
    SFSNDK VARCHAR(1)    COMMENT '' ,
    SNDKLX VARCHAR(3)    COMMENT '' ,
    SFJZFPDK VARCHAR(1)    COMMENT '' ,
    SFJDLKPKRKDK VARCHAR(1)    COMMENT '' ,
    SFDFZFRZPTDK VARCHAR(1)    COMMENT '' ,
    DFRZPTAFLXZFLLX VARCHAR(2)    COMMENT '' ,
    DFRZPTALSGXFLLX VARCHAR(2)    COMMENT '' ,
    DFRZPTCZZJLYFL VARCHAR(2)    COMMENT '' ,
    SFBZXAJGCDK VARCHAR(1)    COMMENT '' ,
    BZXAJGCDKLX VARCHAR(4)    COMMENT '' ,
    SFLSDK VARCHAR(1)    COMMENT '' ,
    SFCYDBDK VARCHAR(1)    COMMENT '' ,
    CYDBDKLX VARCHAR(3)    COMMENT '' ,
