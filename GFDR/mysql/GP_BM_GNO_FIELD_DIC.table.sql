CREATE TABLE GP_BM_GNO_FIELD_DIC(
    ...
    FIELD_NAME VARCHAR(60)    COMMENT '字段名字' ,
    FIELD_ID VARCHAR(20)    COMMENT '字段标识' ,
    FIELD_TYPE VARCHAR(20)    COMMENT '字段类型（默认）' ,
    FIELD_LEN VARCHAR(8)    COMMENT '字段长度（默认）' ,
    FIELD_TBL_SIZE VARCHAR(8)    COMMENT '字段表长度（默认）' ,
