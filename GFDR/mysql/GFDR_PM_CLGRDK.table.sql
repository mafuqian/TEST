CREATE TABLE GFDR_PM_CLGRDK(
    ...
    DKYEZRMB_AMT NUMERIC(22,2)    COMMENT '贷款余额折人民币' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '存量个人贷款信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_CLGRDK ADD UNIQUE U_CLGRDK(DATA_RPT_DATE,JRJGDM,DKJJBM,DKHTBM);