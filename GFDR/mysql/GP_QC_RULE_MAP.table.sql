CREATE TABLE GP_QC_RULE_MAP(
    ...
    RULE_SET_ID VARCHAR(64)    COMMENT '规则集 ID' ,
    RULE_ID VARCHAR(64)    COMMENT '规则 ID' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '规则映射表' ENGINE=InnoDB;

ALTER TABLE GP_QC_RULE_MAP ADD UNIQUE GP_QC_RULE_MAP_UNIQ(RULE_SET_ID,RULE_ID);