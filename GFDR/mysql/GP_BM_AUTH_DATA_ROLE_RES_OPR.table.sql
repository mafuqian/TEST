CREATE TABLE GP_BM_AUTH_DATA_ROLE_RES_OPR(
    DATA_ID VARCHAR(64) NOT NULL   COMMENT '数据ID' ,
    ROLE_ID VARCHAR(64)    COMMENT '角色ID' ,
    RES_ID VARCHAR(64)    COMMENT '资源ID' ,
    OPR_CONF_ID VARCHAR(64)    COMMENT '操作者ID' ,
    COL_NAME VARCHAR(64)    COMMENT '操作者字段名' ,
    COL_VALUE VARCHAR(64)    COMMENT '操作者字段值' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '角色资源操作者配置' ENGINE=InnoDB;
