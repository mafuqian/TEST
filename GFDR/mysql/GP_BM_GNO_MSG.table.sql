CREATE TABLE GP_BM_GNO_MSG(
    ...
    MSG_ID VARCHAR(64)    COMMENT '数据ID' ,
    SEQ_NO VARCHAR(32)    COMMENT '消息序号' ,
    MSG_SENDER VARCHAR(32)    COMMENT '数据发送者' ,
    MSG_CODE VARCHAR(32)    COMMENT '消息编码' ,
    MSG_TYPE VARCHAR(32)    COMMENT '消息类型' ,
    MSG_FMT VARCHAR(20)    COMMENT '报文格式' ,
    SEND_DATE CHAR(8)    COMMENT '消息发送日期' ,
    SEND_NODE VARCHAR(32)    COMMENT '发送节点' ,
    REF_ID VARCHAR(32)    COMMENT '关联ID' ,
    MSG_FILE VARCHAR(512)    COMMENT '消息文件' ,
    DATA_FILE VARCHAR(512)    COMMENT '数据文件' ,
    TOPIC VARCHAR(32)    COMMENT '消息主题' ,
    TPL_ID VARCHAR(32)    COMMENT '模板ID' ,
