CREATE TABLE GP_BM_ROLE_INFO_PENDING(
    ...
    ROLE_ID VARCHAR(32)    COMMENT '岗位ID' ,
    ROLE_NAME VARCHAR(90)    COMMENT '岗位名称' ,
    STATUS CHAR(1)    COMMENT '状态' ,
    EFFECT_DATE CHAR(8)    COMMENT '有效日期开始' ,
    EXPIRE_DATE CHAR(8)    COMMENT '有效日期结束' ,
    LAST_UPD_DATE CHAR(8)    COMMENT '最后更新日期' ,
    LAST_UPD_FUNC NUMERIC(38,0)    COMMENT '最后更新功能ID' ,
    LAST_UPD_TLR CHAR(8)    COMMENT '最后更新人' ,
    MISCFLGS CHAR(20)    COMMENT '扩展标志位' ,
    MISC VARCHAR(256)    COMMENT '扩展标志位' ,
    ROLE_TYPE CHAR(1)    COMMENT '角色类型：枚举' ,
    ...
    ST CHAR(1)    COMMENT '' ,
    CRT_DT CHAR(8)    COMMENT '' ,
    GPMS_NEXT_ACTION VARCHAR(2)    COMMENT '' ,
    BUSINESS_LINE VARCHAR(4000)    COMMENT '' ,
    PRIMARY KEY (DATA_ID)
) COMMENT = '角色pending表' ENGINE=InnoDB;
