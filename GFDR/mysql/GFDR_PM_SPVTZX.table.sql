CREATE TABLE GFDR_PM_SPVTZX(
    ...
    TZYE_AMT NUMERIC(22,2)    COMMENT '投资余额' ,
    TZYEZRMB_AMT NUMERIC(22,2)    COMMENT '投资余额折人民币' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '存量特定目的载体投资信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_SPVTZX ADD UNIQUE U_SPVTZX(DATA_RPT_DATE,JRJGDM,ZGCPTJBM);