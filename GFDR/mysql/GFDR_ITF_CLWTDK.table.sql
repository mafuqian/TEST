CREATE TABLE GFDR_ITF_CLWTDK(
    ...
    WTDKJJBM VARCHAR(100)    COMMENT '' ,
    WTDKHTBM VARCHAR(100)    COMMENT '' ,
    DKSJTX VARCHAR(4)    COMMENT '' ,
    WTDKFFRQ_DATE VARCHAR(10)    COMMENT '' ,
    WTDKDQRQ_DATE VARCHAR(10)    COMMENT '' ,
    WTDKZQDQRQ_DATE VARCHAR(10)    COMMENT '' ,
    BZ VARCHAR(3)    COMMENT '' ,
    WTDKYE_AMT NUMERIC(22,2)    COMMENT '' ,
    WTDKYEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    LLSFGD VARCHAR(4)    COMMENT '' ,
    LLSP NUMERIC(15,5)    COMMENT '' ,
    SXFJEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    DKDBFS VARCHAR(3)    COMMENT '' ,
    DKZL VARCHAR(4)    COMMENT '' ,
    DKZT VARCHAR(4)    COMMENT '' ,
    WTRGMJJBM VARCHAR(3)    COMMENT '' ,
    WTRZJLX VARCHAR(3)    COMMENT '' ,
    WTRZJDM VARCHAR(60)    COMMENT '' ,
    WTRHY VARCHAR(3)    COMMENT '' ,
    WTRDQDM VARCHAR(6)    COMMENT '' ,
    WTRJJCF VARCHAR(5)    COMMENT '' ,
    WTRQYGM VARCHAR(4)    COMMENT '' ,
