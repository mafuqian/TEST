CREATE TABLE GP_BM_BUSINESS_PARAM(
    ...
    PARAM_ID VARCHAR(30)    COMMENT '参数ID' ,
    PARAM_GROUP_ID VARCHAR(20)    COMMENT '参数组号' ,
    PARAM_START_DT CHAR(8)    COMMENT '有效期起' ,
    PARAM_END_DT CHAR(8)    COMMENT '有效止日' ,
    PARAM_NAME VARCHAR(512)    COMMENT '参数名称' ,
    PARAM_VALUE VARCHAR(512) NOT NULL   COMMENT '参数值' ,
    LOAD_TYPE CHAR(1)    COMMENT '加载方式' ,
    IF_CANMODIFY CHAR(1)    COMMENT '是否可修改' ,
    CATALOG VARCHAR(100)    COMMENT '参数分类' ,
    LAST_UPD_TLR CHAR(8)    COMMENT '最后更新操作员' ,
    LAST_UPD_FUNC VARCHAR(10)    COMMENT '最后修改交易码' ,
    LAST_UPD_DATE CHAR(8)    COMMENT '最后更新时间' ,
