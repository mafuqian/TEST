CREATE TABLE GFDR_PM_TYCKFS(
    ...
    YWLX VARCHAR(4)    COMMENT '业务类型' ,
    JYDSZJLX VARCHAR(3)    COMMENT '交易对手证件类型' ,
    JYDSDM VARCHAR(60)    COMMENT '交易对手代码' ,
    CKZHBM VARCHAR(60)    COMMENT '存款账户编码' ,
    CKXYDM VARCHAR(60)    COMMENT '存款协议代码' ,
    XYQSRQ_DATE VARCHAR(8)    COMMENT '协议起始日期' ,
    XYDQRQ_DATE VARCHAR(8)    COMMENT '协议到期日期' ,
    ...
    JYZHH VARCHAR(60)    COMMENT '交易账户号' ,
    JYZHKHHH VARCHAR(30)    COMMENT '交易账户开户行号' ,
    JYDSZHH VARCHAR(60)    COMMENT '交易对手账户号' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '同业存款发生额信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_TYCKFS ADD UNIQUE U_TYCKFS(DATA_RPT_DATE,JRJGDM,CKZHBM,CKXYDM,JYLSH);