CREATE TABLE GFDR_ITF_CLZQFX(
    ...
    QMZQMZ_AMT NUMERIC(22,2)    COMMENT '' ,
    QMZQMZZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    QMZQYE_AMT NUMERIC(22,2)    COMMENT '' ,
    QMZQYEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    ZQZWDJR_DATE VARCHAR(10)    COMMENT '' ,
    QXR_DATE VARCHAR(10)    COMMENT '' ,
    DFRQ_DATE VARCHAR(10)    COMMENT '' ,
    FXFS VARCHAR(2)    COMMENT '' ,
