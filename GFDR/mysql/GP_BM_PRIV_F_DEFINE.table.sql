CREATE TABLE GP_BM_PRIV_F_DEFINE(
    ...
    F_ID VARCHAR(60)    COMMENT '功能ID' ,
    F_TYPE CHAR(1)    COMMENT '功能类型 V-画面   I-接口' ,
    CODE_SCHEMA VARCHAR(30)    COMMENT '采用的数据编码方案' ,
    ENABLE_FLAG CHAR(1)    COMMENT '权限启用开关 1-开启   2-关闭' ,
