CREATE TABLE GFDR_ITF_DWCKFS(
    ...
    KHZCDZ VARCHAR(400)    COMMENT '' ,
    KHDQDM VARCHAR(6)    COMMENT '' ,
    CKZHBM VARCHAR(60)    COMMENT '' ,
    CKXYDM VARCHAR(60)    COMMENT '' ,
    CKCPLB VARCHAR(5)    COMMENT '' ,
    CKXYQSRQ_DATE VARCHAR(10)    COMMENT '' ,
    CKXYDQRQ_DATE VARCHAR(10)    COMMENT '' ,
    CKXYSJZZRQ_DATE VARCHAR(10)    COMMENT '' ,
    CKBZ VARCHAR(3)    COMMENT '' ,
    CKFSJE_AMT NUMERIC(22,2)    COMMENT '' ,
    CKFSJEZRMB_AMT NUMERIC(22,2)    COMMENT '' ,
    LLSP NUMERIC(15,5)    COMMENT '' ,
    JYRQ_DATE VARCHAR(10)    COMMENT '' ,
    JYLSH VARCHAR(60)    COMMENT '' ,
    JYFX VARCHAR(1)    COMMENT '' ,
    JYQD VARCHAR(2)    COMMENT '' ,
    XJZZBZ VARCHAR(1)    COMMENT '' ,
