CREATE TABLE GP_BM_UPLOAD_LOG(
    ...
    REAL_PATH VARCHAR(300)    COMMENT '实际路径' ,
    BEFORE_UPLOAD_NAME VARCHAR(180)    COMMENT '上传前文件名' ,
    BEGIN_TIME VARCHAR(14)    COMMENT '开始上传时间' ,
    END_TIME VARCHAR(14)    COMMENT '结束上传时间' ,
    IP VARCHAR(512)    COMMENT '上传IP地址' ,
    STATUS VARCHAR(2)    COMMENT '状态' ,
    ERR_CODE VARCHAR(30)    COMMENT '错误码' ,
