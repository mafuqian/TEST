CREATE TABLE GFDR_PM_CLWTDK(
    ...
    WTDKZQDQRQ_DATE VARCHAR(8)    COMMENT '委托贷款展期到期日期' ,
    BZ VARCHAR(3)    COMMENT '币种' ,
    WTDKYE_AMT NUMERIC(22,2)    COMMENT '委托贷款余额' ,
    WTDKYEZRMB_AMT NUMERIC(22,2)    COMMENT '委托贷款余额折人民币' ,
    ...
    PRIMARY KEY (DATA_ID)
) COMMENT = '存量委托贷款信息' ENGINE=InnoDB;

ALTER TABLE GFDR_PM_CLWTDK ADD UNIQUE U_CLWTDK(DATA_RPT_DATE,JRJGDM,WTDKJJBM,WTDKHTBM);