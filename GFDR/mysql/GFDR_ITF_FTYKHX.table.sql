CREATE TABLE GFDR_ITF_FTYKHX(
    ...
    KHMC VARCHAR(200)    COMMENT '' ,
    KHZJLX VARCHAR(3)    COMMENT '' ,
    KHZJDM VARCHAR(60)    COMMENT '' ,
    JBCKZH VARCHAR(60)    COMMENT '' ,
    JBZHKHHMC VARCHAR(200)    COMMENT '' ,
    JYFW VARCHAR(3000)    COMMENT '' ,
    ZCZB_AMT NUMERIC(22,2)    COMMENT '' ,
    SSZB_AMT NUMERIC(22,2)    COMMENT '' ,
    ZZC_AMT NUMERIC(22,2)    COMMENT '' ,
    YYSR_AMT NUMERIC(22,2)    COMMENT '' ,
    CYRYS NUMERIC(10)    COMMENT '' ,
    SFSSGS VARCHAR(1)    COMMENT '' ,
    SCJLXDGXRQ_DATE VARCHAR(10)    COMMENT '' ,
    ZCDZ VARCHAR(400)    COMMENT '' ,
    DQDM VARCHAR(6)    COMMENT '' ,
    JYZT VARCHAR(2)    COMMENT '' ,
    CLRQ_DATE VARCHAR(10)    COMMENT '' ,
    SSHY VARCHAR(3)    COMMENT '' ,
    QYGM VARCHAR(4)    COMMENT '' ,
    KHJJCF VARCHAR(5)    COMMENT '' ,
    KHGMJJBM VARCHAR(3)    COMMENT '' ,
    SXED_AMT NUMERIC(22,2)    COMMENT '' ,
    YYED_AMT NUMERIC(22,2)    COMMENT '' ,
    SFGLF VARCHAR(1)    COMMENT '' ,
    SJKZRZJLX VARCHAR(60)    COMMENT '' ,
    SJKZRZJDM VARCHAR(400)    COMMENT '' ,
    KHXYJBZDJS NUMERIC(3)    COMMENT '' ,
    KHXYPJ NUMERIC(3)    COMMENT '' ,
