CREATE TABLE GP_BM_BMS_BATCH_METHOD(
    ...
    BATCH_NAME VARCHAR(60)    COMMENT '' ,
    JOB_TYPE VARCHAR(60)    COMMENT '' ,
    ARGS VARCHAR(256)    COMMENT '' ,
    BATCH_SEQ VARCHAR(60)    COMMENT '' ,
    BATCH_ID VARCHAR(32)    COMMENT '' ,
    BATCH_STATUS CHAR(1)    COMMENT '' ,
    BATCH_FLAG CHAR(1)    COMMENT '' ,
    BATCH_DATE CHAR(1)    COMMENT '' ,
    BATH_DESC VARCHAR(128)    COMMENT '' ,
