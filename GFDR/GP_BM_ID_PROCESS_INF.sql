CREATE TABLE GP_BM_ID_PROCESS_INF(
    DATA_ID VARCHAR(64) NOT NULL   COMMENT '数据ID' ,
    IMPORT_ID VARCHAR(64)    COMMENT '导入任务ID' ,
    IMPORT_NAME VARCHAR(255)    COMMENT '导入文件名' ,
    IMPORT_STATUS VARCHAR(2)    COMMENT '状态 0,开始;9,结束;-1,中断' ,
    IMPORT_DESC VARCHAR(255)    COMMENT '描述' ,
    IMPORT_OWNER VARCHAR(64)    COMMENT '导入用户' ,
    TOTAL_NUM INT    COMMENT '总数据' ,
    PROCESSED_NUM INT    COMMENT '已处理数' ,
    CORRECT_NUM INT    COMMENT '正确数' ,
    ERROR_NUM INT    COMMENT '错误数' ,
    FILTER_NUM INT    COMMENT '过滤数' ,
    ...
    GROUP_ID VARCHAR(14)    COMMENT '部门编号' ,
    INQ_ORG_ID CHAR(24)    COMMENT '查询机构号' ,
    INQ_GROUP_ID CHAR(24)    COMMENT '查询组号' ,
    CHECK_FLAG CHAR(1)    COMMENT '校验标识' ,
    CHECK_DESC VARCHAR(512)    COMMENT '校验结果' ,
