                    ...
                    USING (SELECT DISTINCT A.*,
                                           CASE
                                               WHEN A.H_SETT_DATE IS NOT NULL AND
                                                    SUBSTR(A.H_SETT_DATE, 1, 6) = SUBSTR(V_T_DATE, 1, 6) THEN
                                                   GET_WORKDAY(A.H_SETT_DATE)
                ...
                BEGIN
                    ...
                    SELECT DISTINCT CASE
                                        ...
                                        WHEN SUBSTR(A.C_OPEN_DATE, 1, 6) = SUBSTR(V_T_DATE, 1, 6) AND
                                             ((A.B_ACCT_TYPE <> 'C1' AND A.H_ACCT_STATUS NOT IN ('3', '4')) OR
                                              ((A.B_ACCT_TYPE = 'C1' AND A.H_ACCT_STATUS <> '2')))
                                        ...
                                        WHEN A.MON_SETTLE_DATE = V_T_DATE AND
                                             A.B_ACCT_TYPE <> 'C1' AND A.H_ACCT_STATUS NOT IN ('3', '4')
                                            AND E.DATA_ID IS NULL THEN
                                            '31'
                                        --月结日账户关闭：不为C1的数据，已报送过，账户状态为关闭，且执行日=月结日
                                        WHEN A.B_ACCT_TYPE <> 'C1' AND A.H_ACCT_STATUS IN ('3', '4') AND
                                             E.DATA_ID IS NOT NULL AND
                                             A.MON_SETTLE_DATE = V_T_DATE THEN
                                            '32'
                                        --账户关闭：已报送过，账户状态为关闭
                                        WHEN ((A.B_ACCT_TYPE <> 'C1' AND A.H_ACCT_STATUS IN ('3', '4')) OR
                                        ...
                                        WHEN A.J_TOT_OVERD = 0 AND (J.DATA_ID IS NOT NULL AND
                                                                    ((A.B_ACCT_TYPE <> 'C1' AND J.H_TOT_OVERD <> 0) OR
                                                                     (A.B_ACCT_TYPE = 'C1' AND J.J_TOT_OVERD <> 0))) AND
                                             A.MON_SETTLE_DATE <> A.J_LAT_RPY_DATE AND
                                        ...
                                        WHEN TRIM(A.C_BUSI_LINES || A.C_BUSI_DTL_LINES || A.C_OPEN_DATE || A.C_CY ||
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     (A.C_BUSI_LINES || A.C_BUSI_DTL_LINES || A.C_OPEN_DATE || A.C_CY ||
                                                      ...
                                                      A.C_ASSET_TRAND_FLAG || A.C_FUND_SOU || A.C_LOAN_FORM ||
                                                      A.C_CREDIT_ID || A.C_LOAN_CON_CODE || A.C_FIRST_HOU_LOAN_FLAG ||
                                                      A.C_ACCT_CRED_LINE_AMT_LCY || A.C_LOAN_AMT_LCY) <>
                                                     (J.C_BUSI_LINES || J.C_BUSI_DTL_LINES || J.C_OPEN_DATE || J.C_CY ||
                                                      J.C_ACCT_CRED_LINE_AMT || J.C_LOAN_AMT || J.C_FLAG ||
                                                      J.C_DUE_DATE ||
                                                      J.C_REPAY_MODE || J.C_REPAY_FREQCY || J.C_REPAY_PRD ||
                                                      J.C_APPLY_BUSI_DIST || J.C_GUAR_MODE || J.C_OTH_REPY_GUAR_WAY ||
                                                      J.C_ASSET_TRAND_FLAG || J.C_FUND_SOU || J.C_LOAN_FORM ||
                                                      J.C_CREDIT_ID || J.C_LOAN_CON_CODE || J.C_FIRST_HOU_LOAN_FLAG ||
                                                      J.C_ACCT_CRED_LINE_AMT_LCY || J.C_LOAN_AMT_LCY)
                                                    THEN
                                                    '1'
                                                ELSE
                                                    '0'
                                    ...
                                    CASE
                                        WHEN TRIM(A.F_MCC) IS NOT NULL THEN
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND (A.F_MCC) <> (J.F_MCC)
                                                    THEN
                                                    '1'
                                                ELSE
                                                    '0'
                                    ...
                                    CASE
                                        WHEN TRIM(A.G_INIT_CRED_NAME || A.G_INIT_CRED_ORG_NM || A.G_ORIG_DBT_CATE ||
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     (A.G_INIT_CRED_NAME || A.G_INIT_CRED_ORG_NM || A.G_ORIG_DBT_CATE ||
                                                      A.G_INIT_RPY_STS) <>
                                                     (J.G_INIT_CRED_NAME || J.G_INIT_CRED_ORG_NM || J.G_ORIG_DBT_CATE ||
                                                      J.G_INIT_RPY_STS)
                                                    THEN
                                                    '1'
                                                ELSE
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     (A.H_MONTH || A.H_SETT_DATE || A.H_ACCT_STATUS ||
                                                      ...
                                                      A.H_CUR_RPY_AMT_LCY || A.H_ACT_RPY_AMT_LCY || A.H_LAT_RPY_DATE ||
                                                      A.H_CLOSE_DATE) <>
                                                     (J.H_MONTH || J.H_SETT_DATE || J.H_ACCT_STATUS ||
                                                      J.H_ACCT_BAL_LCY ||
                                                      J.H_PRID_ACCT_BAL_LCY || J.H_USED_AMT_LCY || J.H_NOTLSU_BAL_LCY ||
                                                      ...
                                                      J.H_CUR_RPY_AMT_LCY || J.H_ACT_RPY_AMT_LCY || J.H_LAT_RPY_DATE ||
                                                      J.H_CLOSE_DATE)
                                                    THEN
                                                    '1'
                                                ELSE
                                    ...
                                    CASE
                                        WHEN TRIM(A.I_SPEC_LINE_LCY || A.I_SPEC_EFCT_DATE || A.I_SPEC_END_DATE ||
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     (A.I_SPEC_LINE_LCY || A.I_SPEC_EFCT_DATE || A.I_SPEC_END_DATE ||
                                                      A.I_USED_INST_AMT_LCY) <>
                                                     (J.I_SPEC_LINE_LCY || J.I_SPEC_EFCT_DATE || J.I_SPEC_END_DATE ||
                                                      J.I_USED_INST_AMT_LCY)
                                                    THEN
                                                    '1'
                                                ELSE
                                                    '0'
                                    ...
                                    CASE
                                        WHEN TRIM(A.J_ACCT_STATUS || A.J_ACCT_BAL_LCY || A.J_FIVE_CATE ||
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     (A.J_ACCT_STATUS || A.J_ACCT_BAL_LCY || A.J_FIVE_CATE ||
                                                      A.J_FIVE_CATE_ADJ_DATE || A.J_REM_REP_PRD || A.J_RPY_STATUS ||
                                                      A.J_OVERD_PRD || A.J_TOT_OVERD_LCY || A.J_LAT_RPY_AMT_LCY ||
                                                      A.J_LAT_RPY_DATE || A.J_CLOSE_DATE) <>
                                                     (J.J_ACCT_STATUS || J.J_ACCT_BAL_LCY || J.J_FIVE_CATE ||
                                                      J.J_FIVE_CATE_ADJ_DATE || J.J_REM_REP_PRD || J.J_RPY_STATUS ||
                                                      J.J_OVERD_PRD || J.J_TOT_OVERD_LCY || J.J_LAT_RPY_AMT_LCY ||
                                                      J.J_LAT_RPY_DATE || J.J_CLOSE_DATE)
                                                    THEN
                                                    '1'
                                                ELSE
                                                    '0'
                    ...
                    SELECT GET_ISRPT_CHANGE(IS_RPT_OUT,
                                            ('1' || C_UPDATE_FLAG || F_UPDATE_FLAG || G_UPDATE_FLAG || H_UPDATE_FLAG ||
                                             I_UPDATE_FLAG || J_UPDATE_FLAG))
                    INTO IS_RPT_OUT
                    FROM DUAL;
                END;

                DSC := '##修改子表[MBT_220_D] IS_RPT##';
                DBMS_OUTPUT.PUT_LINE(DSC);
                BEGIN
                        ...
                        USING (SELECT A.*,
                                      ...
                                      CASE
                                          WHEN D.DATA_ID IS NOT NULL AND
                                               TRIM(A.C_BUSI_LINES || A.C_BUSI_DTL_LINES || A.C_OPEN_DATE ||
                                                    ...
                                                    A.C_ACCT_CRED_LINE_AMT_LCY || A.C_LOAN_AMT_LCY) IS NOT NULL THEN
                                              CASE
                                                  WHEN (A.C_BUSI_LINES || A.C_BUSI_DTL_LINES || A.C_OPEN_DATE ||
                                                        A.C_CY ||
                                                        A.C_ACCT_CRED_LINE_AMT || A.C_LOAN_AMT || A.C_FLAG ||
                                                        A.C_DUE_DATE ||
                                                        A.C_REPAY_MODE || A.C_REPAY_FREQCY || A.C_REPAY_PRD ||
                                                        ...
                                                        A.C_ACCT_CRED_LINE_AMT_LCY || A.C_LOAN_AMT_LCY) <>
                                                       (B.C_BUSI_LINES || B.C_BUSI_DTL_LINES || B.C_OPEN_DATE ||
                                                        B.C_CY ||
                                                        ...
                                                        B.C_ACCT_CRED_LINE_AMT_LCY || B.C_LOAN_AMT_LCY)
                                                      THEN
                                                      CASE
                                                          WHEN (A.C_BUSI_LINES || A.C_BUSI_DTL_LINES ||
                                                                A.C_OPEN_DATE ||
                                                                A.C_CY ||
                                                                ...
                                                                A.C_FIRST_HOU_LOAN_FLAG ||
                                                                A.C_ACCT_CRED_LINE_AMT_LCY || A.C_LOAN_AMT_LCY) <>
                                                               (C.C_BUSI_LINES || C.C_BUSI_DTL_LINES ||
                                                                C.C_OPEN_DATE ||
                                                                C.C_CY ||
                                                                ...
                                                                C.C_ACCT_CRED_LINE_AMT_LCY || C.C_LOAN_AMT_LCY)
                                                              THEN
                                                              '1'
                                                          ELSE
                                                              '0'
                                      ...
                                      CASE
                                          WHEN D.DATA_ID IS NOT NULL AND TRIM(A.F_MCC) IS NOT NULL THEN
                                              CASE
                                                  WHEN (A.F_MCC) <> (B.F_MCC)
                                                      THEN
                                                      CASE
                                                          WHEN (A.F_MCC) <> (C.F_MCC)
                                                              THEN
                                                              '1'
                                                          ELSE
                                                              '0'
                                          ...
                                          WHEN D.DATA_ID IS NOT NULL AND
                                              ...
                                              CASE
                                                  WHEN
                                                      ...
                                                      THEN
                                                      CASE
                                                          WHEN (A.G_INIT_CRED_NAME || A.G_INIT_CRED_ORG_NM ||
                                                                A.G_ORIG_DBT_CATE ||
                                                                A.G_INIT_RPY_STS) <>
                                                               (C.G_INIT_CRED_NAME || C.G_INIT_CRED_ORG_NM ||
                                                                C.G_ORIG_DBT_CATE ||
                                                                C.G_INIT_RPY_STS)
                                                              THEN
                                                              '1'
                                              ...
                                              CASE
                                                  WHEN
                                                          (A.H_MONTH || A.H_SETT_DATE || A.H_ACCT_STATUS ||
                                                           ...
                                                           A.H_LAT_RPY_DATE ||
                                                           A.H_CLOSE_DATE) <>
                                                          (B.H_MONTH || B.H_SETT_DATE || B.H_ACCT_STATUS ||
                                                           B.H_ACCT_BAL_LCY ||
                                                      ...
                                                      THEN
                                                      CASE
                                                          WHEN (A.H_MONTH || A.H_SETT_DATE || A.H_ACCT_STATUS ||
                                                                A.H_ACCT_BAL_LCY ||
                                                                A.H_PRID_ACCT_BAL_LCY || A.H_USED_AMT_LCY ||
                                                                A.H_NOTLSU_BAL_LCY ||
                                                                A.H_REM_REP_PRD || A.H_FIVE_CATE ||
                                                                ...
                                                                A.H_LAT_RPY_DATE ||
                                                                A.H_CLOSE_DATE) <>
                                                               (C.H_MONTH || C.H_SETT_DATE || C.H_ACCT_STATUS ||
                                                                C.H_ACCT_BAL_LCY ||
                                      ...
                                      CASE
                                          WHEN D.DATA_ID IS NOT NULL AND
                                              ...
                                              CASE
                                                  WHEN
                                                          (A.I_SPEC_LINE_LCY || A.I_SPEC_EFCT_DATE ||
                                                           A.I_SPEC_END_DATE ||
                                                           A.I_USED_INST_AMT_LCY) <>
                                                          (B.I_SPEC_LINE_LCY || B.I_SPEC_EFCT_DATE ||
                                                           B.I_SPEC_END_DATE ||
                                                           B.I_USED_INST_AMT_LCY)
                                                      THEN
                                                      CASE
                                                          WHEN (A.I_SPEC_LINE_LCY || A.I_SPEC_EFCT_DATE ||
                                                                A.I_SPEC_END_DATE ||
                                                                A.I_USED_INST_AMT_LCY) <>
                                                               (C.I_SPEC_LINE_LCY || C.I_SPEC_EFCT_DATE ||
                                                                C.I_SPEC_END_DATE ||
                                                                C.I_USED_INST_AMT_LCY)
                                                              THEN
                                                              '1'
                                                          ELSE
                                                              '0'
                                              ...
                                              CASE
                                                  WHEN
                                                          (A.J_ACCT_STATUS || A.J_ACCT_BAL_LCY || A.J_FIVE_CATE ||
                                                           ...
                                                           A.J_LAT_RPY_AMT_LCY ||
                                                           A.J_LAT_RPY_DATE || A.J_CLOSE_DATE) <>
                                                          (B.J_ACCT_STATUS || B.J_ACCT_BAL_LCY || B.J_FIVE_CATE ||
                                                           B.J_FIVE_CATE_ADJ_DATE || B.J_REM_REP_PRD ||
                                                           B.J_RPY_STATUS ||
                                                           B.J_OVERD_PRD || B.J_TOT_OVERD_LCY ||
                                                           B.J_LAT_RPY_AMT_LCY ||
                                                           B.J_LAT_RPY_DATE || B.J_CLOSE_DATE)
                                                      THEN
                                                      CASE
                                                          WHEN (A.J_ACCT_STATUS || A.J_ACCT_BAL_LCY ||
                                                                A.J_FIVE_CATE ||
                                                                A.J_FIVE_CATE_ADJ_DATE || A.J_REM_REP_PRD ||
                                                                A.J_RPY_STATUS ||
                                                                A.J_OVERD_PRD || A.J_TOT_OVERD_LCY ||
