                    ...
                    SELECT DISTINCT CASE
                                        ...
                                        WHEN TRIM(A.C_BUSI_LINES || A.C_BUSI_DTL_LINES || A.C_OPEN_DATE || A.C_CY ||
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     ...
                                                     nvl(J.C_BUSI_LINES || J.C_BUSI_DTL_LINES || J.C_OPEN_DATE || J.C_CY ||
                                    ...
                                    CASE
                                        WHEN TRIM(A.G_INIT_CRED_NAME || A.G_INIT_CRED_ORG_NM || A.G_ORIG_DBT_CATE ||
                                            ...
                                            CASE
                                                WHEN J.DATA_ID IS NOT NULL AND
                                                     nvl(A.G_INIT_CRED_NAME || A.G_INIT_CRED_ORG_NM || A.G_ORIG_DBT_CATE ||
                                                      A.G_INIT_RPY_STS, 0) <>
                                                     nvl(J.G_INIT_CRED_NAME || J.G_INIT_CRED_ORG_NM || J.G_ORIG_DBT_CATE ||
                                                      J.G_INIT_RPY_STS, 0)
                                                    THEN
                                                    '1'
                                                ELSE
