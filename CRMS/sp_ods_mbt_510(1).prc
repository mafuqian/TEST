                                        ...
                                        FROM (SELECT CASE
                                              ...
                                              FROM MBT_510_E A
                                                       FULL JOIN (SELECT A.*
                                                                 ...
                                                                 ON A.E_PLE_TYPE = B.E_PLE_TYPE AND
                                                                    A.E_MOTGA_PROPT_ID_TYPE = B.E_MOTGA_PROPT_ID_TYPE AND
                                                                    A.E_PLE_CERT_ID = B.E_PLE_CERT_ID AND
                                                                    A.E_PLE_DISTR = B.E_PLE_DISTR AND
                                                                    A.E_PLE_VALUE = B.E_PLE_VALUE AND
                                                                    A.E_PLE_CY = B.E_PLE_CY AND
                                                                    A.E_VAL_ORG_TYPE = B.E_VAL_ORG_TYPE AND
                                                                    A.E_VAL_DATE = B.E_VAL_DATE AND
                                                                    A.E_PLEDGOR_TYPE = B.E_PLEDGOR_TYPE AND
                                                                    A.E_PLEDGOR_NAME = B.E_PLEDGOR_NAME AND
                                                                    A.E_PLEOR_CERT_TYPE = B.E_PLEOR_CERT_TYPE AND
                                                                    A.E_PLEOR_CERT_NUM = B.E_PLEOR_CERT_NUM AND
                                                                    A.E_PLE_DESC = B.E_PLE_DESC AND
                                                       ...
                                                       FULL JOIN (SELECT A.*
                                                                  FROM MBT_510_F_RPT A,
                                                                       (SELECT *
                                                                        ...
                                                                        WHERE RN = 1) B
                                                                  WHERE A.PDATA_ID = B.DATA_ID) B
                                                                 ON A.F_IMP_TYPE = B.F_IMP_TYPE AND
                                                                    A.F_IMP_VAL = B.F_IMP_VAL AND
                                                                    A.F_IMP_CY = B.F_IMP_CY AND
                                                                    A.F_IPPC = B.F_IPPC AND
                                                                    A.F_PAWN_NAME = B.F_PAWN_NAME AND
                                                                    A.F_PAWN_CERT_TYPE = B.F_PAWN_CERT_TYPE AND
                                                                    A.F_PAWN_CERT_NUM = B.F_PAWN_CERT_NUM AND
                                                                    A.B_CC_CODE = B.B_CC_CODE)
                                        WHERE FLAG > 0
